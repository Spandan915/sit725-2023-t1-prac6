...
describe("Multiplicatio of two numbers ", function() {
    var url = "http://localhost:8080/multiplication/10/2";
  ...
  describe("Multiplication of two strings", function() {
    var url = "http://localhost:8080/multiplication/s/s";
  ...
  describe("Division of two numbers ", function() {
    var url = "http://localhost:8080/division/20/2";
    it("returns status 200 to check if api works", function(done) {
        request(url, function(error, response, body) {
            expect(response.statusCode).to.equal(200);
            done()
  ...
  describe("Division of two strings", function() {
    var url = "http://localhost:8080/division/s/s";
    it("should return status 200", function(done) {
        request(url, function(error, response, body) {
            expect(response.statusCode).to.equal(200);
            done()
